        ...
        try {
            ...
            if ((degree != null) && (degree.length() > 0)) {
                ...
                if (request.getParameter("R TO K") != null) {
                    ...
                    out.println("<p>" + degree + " Reaumur are " + kelvin + " Kelvin.</p>");
                }
                if (request.getParameter("K TO R") != null) {
                    String reaumur = cb.ktor(d);
                    out.println("<p>" + degree + " Kelvin are " + reaumur + " Reaumur.</p>");
                }
            } else {
                ...
                out.println("<br/>");
                out.println("<input type=\"submit\" name=\"R TO K\" value=\"R TO K\">"
                        + "<input type=\"submit\" name=\"K TO R\" value=\"K TO R\">");
                out.println("</form>");
            }
        } finally {
            out.println("</body>");
